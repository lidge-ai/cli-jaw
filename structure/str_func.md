...
│   │   ├── runtime-settings.ts ← settings side effects 통합 helper (446L)
...
│   │   ├── mention-watch-match.ts ← mention/talk 조건 + extra subjects + authors/authorDeny (evaluateMessagingAccess는 authors가 있을 때만) (172L)
